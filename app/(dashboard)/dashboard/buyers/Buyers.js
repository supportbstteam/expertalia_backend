...
import Api, { axiosInstance as axios } from '@/app/_library/Api';
...
const Buyers = ({ __filterData }) => {
    ...
    const fetchData = async (pageNo) => {
        const res = await axios.get("/private/buyers", {
            params: {
            ...
            throw err; // Recommended to re-throw the error
        });
    ...
    const deleteRow = (_id) => {
        MySwal.fire({
            ...
            if (result.isConfirmed) {
                const res = await axios.delete("/private/buyers", {
                    params: {
                        _id: _id,
                    }
                }, {
                ...
                <div className="row">
                    <div className="col-12">
                        ...
                        <div className="card filter-box">
                            <div className="card-body">
                                <div className="row">
                                    ...
                                    <div className="col-lg-3 col-md-6 col-12">
                                        <div className="mb-2">
                                            <input type="text" className="form-control" id="email" name="email" placeholder="Buyer Email"
                        ...
                        <div className="text-end my-2">
                            <Link className="btn btn-sm btn-primary" href="/dashboard/buyers/create">+ Add New</Link>
                        </div>
                        <div className="card">
                                                        ...
                                                        return (
                                                            <tr key={i}>
                                                                ...
                                                                <td className="text-center">
                                                                    <Link href={`/dashboard/buyers/edit/${val._id}`} className="btn btn-md" title="Edit">
