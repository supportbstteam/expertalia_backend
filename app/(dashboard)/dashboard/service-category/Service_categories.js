...
const Service_categories = ({__filterData}) => {
  ...
  const fetchData = async (pageNo) => {     
    const res = await Api.service_categories({
  ...
  const deleteRow = (_id)=>{
      MySwal.fire({
          ...
          if(result.isConfirmed){ 
              const res = await Api.delete_service_category({
                  _id: _id,  
              });             
      ...
      <div className="row">   
        <div className="col-12">   
            ...
            <div className="card filter-box">
              <div className="card-body"> 
                    <div className="row">
                        ...
                        <div className="mb-2">
                        <input type="text" className="form-control" id="name" name="name" placeholder="Category name" 
            ...
            <div className="text-end my-2">
              <Link className="btn btn-sm btn-primary" href="/dashboard/service-category/create">+ Add New</Link>
            </div>
            <div className="card">
                          ...
                          return(
                            <tr key={i}>
                              ...
                              <td className="text-center">
                                <Link href={`/dashboard/service-category/edit/${val._id}`} className="btn btn-md" title="Edit">
