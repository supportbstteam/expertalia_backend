        ...
        <div className="row">
          <div className="col-12">
              ...
              <div className="card-body">
                <div className="row">
                  ...
                  <div className="col-lg-3 col-md-6 col-12">
                    <div className="mb-2">
                      <input type="text" className="form-control" id="name" name="name" placeholder="Company Name"
                  ...
                  <div className="col-lg-3 col-md-6 col-12">
                    <div className="mb-2">
                      <input type="text" className="form-control" id="email" name="email" placeholder="Company User Email"
                  ...
                  <div className="col-lg-3 col-md-6 col-12">
                    <div className="mb-2">
                      <input type="text" className="form-control" id="zipCode" name="zipCode" placeholder="Zip code"
            ...
            <div className="text-end my-2">
              <Link className="btn btn-sm btn-primary" href="/dashboard/companies/create">+ Add New</Link>
            </div>
            <div className="card">
                            ...
                            return (
                              <tr key={i}>
                                ...
                                <td className="text-center">
                                  <Link href={`/dashboard/companies/edit/${val._id}`} className="btn btn-md" title="Edit">
