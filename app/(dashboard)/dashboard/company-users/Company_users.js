  ...
  const deleteRow = (_id)=>{
      MySwal.fire({
          ...
          if(result.isConfirmed){ 
              const res = await Api.delete_company_user({
                  _id: _id,  
              });             
    ...
    <div className="pagetitle">
        ...
        <nav>
          <ol className="breadcrumb">
            ...
            <li className="breadcrumb-item active">Company users</li>
          </ol>
        </nav>
    </div>
      ...
      <div className="row">   
        <div className="col-12">   
            ...
            <div className="text-end my-2">
              <Link className="btn btn-sm btn-primary" href="/dashboard/company-users/create">+ Add New</Link>
            </div>
            <div className="card">
                          ...
                          return(
                            <tr key={i}>
                              ...
                              <td className="text-center">
                                <Link href={`/dashboard/company-users/edit/${val._id}`} className="btn btn-md" title="Edit">
