  ...
  const deleteRow = (_id)=>{
      MySwal.fire({
          ...
          if(result.isConfirmed){ 
              const res = await Api.delete_page({
                  _id: _id,  
              });             
      ...
      <div className="row">   
        <div className="col-12">   
            ...
            <div className="text-end my-2">
              <Link className="btn btn-sm btn-primary" href="/dashboard/pages/create">+ Add New</Link>
            </div>
                          ...
                          return(
                            <tr key={i}>
                              ...
                              <td className="text-center">
                                <Link href={`/dashboard/pages/edit/${val._id}`} className="btn btn-md" title="Edit">
